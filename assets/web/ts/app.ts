(function (global) {
  ...
  function createFireSimulation(map) {
    ...
    function publish() {
      ...
      if (nextFireSource?.setData) nextFireSource.setData(frame.zones);
      if (nextIgnitionSource?.setData) nextIgnitionSource.setData(Fire.buildIgnitionFeatureCollection(center));
